...
export default function Tile(props){
    ...
    switch(props.value){
        case 1:
            tileProps = { className: 'tile plr1', text: 'X' };
            break;
        case 2:
            tileProps = { className: 'tile plr2', text: 'O' };
            break;
        default:
            tileProps = { className: 'tile', text: '' };
            break;
    }
  return (
      <div className={tileProps.className} onClick={() => props.move()}>{tileProps.text}</div>
